  ...
  return (
    <div className="flex h-full items-center justify-center bg-gray-400 dark:bg-gray-700 dark:text-white space-x-8 mobile:block desktop:flex tablet:flex laptop:flex">
      <img
        src={noImage}
        alt=""
        className="h-[20rem] w-[20rem] rounded-lg mobile:w-full mobile:h-[16rem] desktop:w-[20rem] desktop:h-[20rem] laptop:w-[20rem] laptop:h-[20rem] tablet:w-[20rem] tablet:h-[20rem]"
      />
